...
<head>
    ...
    <title>Kårhuskommittén KåK</title>

    <!-- Bootstrap Core CSS -->
    <link type="text/css" rel="stylesheet" href="<?php echo get_template_directory_uri() . '/styles/bootstrap.min.css'; ?>">

    <!-- Custom Fonts -->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,600,700,800' rel='stylesheet' type='text/css'>
    <link href='http://fonts.googleapis.com/css?family=Merriweather:400,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
    <link type="text/css" rel="stylesheet" href="<?php echo get_template_directory_uri() . '/styles/font-awesome.min.css'; ?>">

    <!-- Plugin CSS -->
    <link type="text/css" rel="stylesheet" href="<?php echo get_template_directory_uri() . '/styles/animate.min.css'; ?>">

    <!-- Custom CSS -->
    <link type="text/css" rel="stylesheet" href="<?php echo get_template_directory_uri() . '/styles/kak.css'; ?>">
    ...
    <!-- Favicon generated from http://realfavicongenerator.net/ -->
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Kårhuskommittén KåK</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a id ="news-anchor" class="page-scroll" href="#news">Nyheter</a>
                    </li>
                    <li>
                        <a id ="facilities-anchor" class="page-scroll" href="#facilities">Lokaler</a>
                    </li>
                    <li>
                        <a id ="about-anchor" class="page-scroll" href="#about">Om KåK</a>
                    </li>
                    <li>
                        <a id ="aspa-anchor" class="page-scroll" href="#aspa">Aspa</a>
                    </li>
                    <li>
                        <a id ="contact-anchor" class="page-scroll" href="#contact">Kontakt</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
